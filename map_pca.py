...
class_0_data = np.loadtxt("pca_class_0_data.txt")
class_1_data = np.loadtxt("pca_class_1_data.txt")
class_2_data = np.loadtxt("pca_class_2_data.txt")
class_3_data = np.loadtxt("pca_class_3_data.txt")
